...
| Direct-cell affordance                 | PASS    | The opening frame centers one clearly bounded membrane and nucleus as the dominant target; the capture contract verifies its pointer behavior and nearby-cell envelope.                                                                                           |
...
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| Opening board           | A single large rose cell with a purple nucleus occupies the arena center. The immediate cell total, cells/s value, stage chip, compact icon strip, and illustrated producer cards frame that target. Tooltip help identifies `Divide a cell`.                                                     | The direct action and its reward are readable before any specimen prose. This is a game board, not a scientific explainer page.                                                                   | PASS    |
