...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Canonical source gate       | `./check_codebase.sh`: Exit 0; PASS, five checks and 368 Node tests in 1.60 seconds.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| Candidate projection        | `source source_me.sh && python3 devel/verify_candidate.py`: Exit 0; PASS, 1,533 Python tests. The projected worktree path, mode, and blobs remained stable, and the real Git index was preserved. Candidate manifests publish only after this byte-stable re-projection.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| Renderer corpus             | [Contact-sheet review](active_plans/reports/contact_sheet_review.md): PASS for the current 216-frame corpus after independent review of 44 originals: all 36 repaired-lesion combinations plus eight progression samples. The v2 provenance manifest is `output_visual/colony-contact-sheet/manifest.json`, SHA-256 `7788e971d8caf90fa4f9035708efdc8dfd7eb173f3b534c741ce150b7466f3fe`, captured `2026-08-28T21:31:14.013Z`; its index SHA-256 is `3989e3065f3eb1a76edeef9d33ea96446473e8147e3c8917a5adc5e33202f54e`; current `dist/main.js` SHA-256 is `2e3671f6824bdb6152dd36409d1183c70c3cb8593262179c7c0d73073dd89610`; and the 12-asset aggregate is `5b2492f97c893b24550557fae4d9466ff674c990ffbdf41926247a14c9f3d155`. The renderer report SHA-256 is `638610d38525ce6fb422d6bd61ae54ad9decea8f4e3e9309e0782d8ea87af304`, with 36 structural samples and 1,257 unique hashes. |
...
| ------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Type safety, lint, formatting, repository checks, and Node behavior | `./check_codebase.sh`                                                                         | PASS    | Exit 0; all five canonical checks passed and the Node suite reported 368 tests in 1.60 seconds.                                                                                              |
...
| Full nonignored candidate, including documentation graph            | `source source_me.sh && python3 devel/verify_candidate.py`                                    | PASS    | Exit 0; disposable projection passed 1,533 Python tests with stable worktree path, mode, and blobs, and preserved the real index.                                                            |
...
| Stage/seed/viewport/theme visual calibration                        | `node --import tsx tools/colony_contact_sheet.mjs`                                            | PASS    | Exit 0; the current corpus contains 216 frames; independent review inspected 44 originals. The structural report contains 36 samples and 1,257 unique hashes.                                |
