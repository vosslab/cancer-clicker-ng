...
const DEFINITIONS = [
  {
    ...
    playerGoal: {
      title: "Divide the tumor",
      instruction: "Divide once to begin the first growth cycle.",
      progressLabel: "Divisions",
    },
    uiMode: "cell-focus",
  ...
  },
  {
    ...
    playerGoal: {
      title: "Build a microcolony",
      instruction: "Divide the tumor until it reaches 10 cells.",
      progressLabel: "Cells grown",
    },
    uiMode: "colony-grid",
  ...
  },
  {
    ...
    playerGoal: {
      title: "Outgrow diffusion",
      instruction: "Reach 100 cells and own one division machine.",
      progressLabel: "Growth readiness",
    },
  ...
  },
  {
    ...
    playerGoal: {
      title: "Create hypoxia",
      instruction: "Build oxygen pressure to 5 in a viable region.",
      progressLabel: "Oxygen pressure",
    },
    uiMode: "region-map",
  ...
  },
  {
    ...
    playerGoal: {
      title: "Recruit a blood vessel",
      instruction: "Create one viable vessel link.",
      progressLabel: "Viable vessel links",
    },
  ...
  },
  {
    ...
    playerGoal: {
      title: "Start invasion",
      instruction: "Discover 10 routes from a perfused region.",
      progressLabel: "Routes discovered",
    },
    uiMode: "route-board",
  ...
  },
  {
    ...
    playerGoal: {
      title: "Enter circulation",
      instruction: "Commit one cell to a viable route.",
      progressLabel: "Route cells committed",
    },
  ...
  },
  {
    ...
    playerGoal: {
      title: "Seed a new site",
      instruction: "Establish one new destination.",
      progressLabel: "Destinations seeded",
    },
  ...
  },
  {
    ...
    playerGoal: {
      title: "Build metastatic burden",
      instruction: "Reach 1,000 cells and seed two sites.",
      progressLabel: "Sites seeded",
    },
  ...
  },
  {
    ...
    playerGoal: {
      title: "Overcome host tolerance",
      instruction: "Reach 1,000 cells with active tumor pressure.",
      progressLabel: "Host burden",
    },
  ...
  },
  {
    ...
    playerGoal: {
      title: "Immortalize the culture",
      instruction: "Earn Lineage 3 before advancing.",
      progressLabel: "Lineage 3",
    },
  ...
  },
  {
    ...
    playerGoal: {
      title: "Contaminate the network",
      instruction: "Reach 100 culture-dissemination points.",
      progressLabel: "Dissemination",
    },
