...
- `src/style.css` holds the shared board styles; `src/prestige.css` holds the scoped prestige and
  transit layer. Both are authored source and copied into `dist/` at build time.
