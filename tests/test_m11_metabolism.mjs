...
test("M11 metabolic conversion is exact, one-time, and leaves cells untouched", () => {
...
test("M11 conversion rejects locked, unowned, and insufficient states without changing the input", () => {
  const operation = {
    type: "convert-substrate",
    hallmark: "metabolic_deregulation",
...
test("M11 conversion does not create cells in an otherwise idle economy", () => {
  const before = metabolismState();
