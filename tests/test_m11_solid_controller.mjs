...
import { hasFundedAtpAcceleration } from "../src/hallmarks/m11_economy.ts";
...
test("M11 controller intents use simulation time, persist once, and preserve reducer ownership", () => {
  const cases = [
    {
...
test("M11 controller mutation selection consumes the saved keyed offer atomically", () => {
  const source = {
    deterministicSeed: 7,
    eventSequence: 0,
    currentStage: stageId("angiogenic_primary"),
...
test("M11 UI sink semantics follow the authoritative per-sink funding rules", () => {
...
test("M11 controller recovery and persistence failures leave each typed action unchanged", () => {
